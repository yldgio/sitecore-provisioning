...
$url = "http://downloads.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-3.6.2.zip" 
$zipFile = "$mongoDbPath\mongo.zip" 
$unzippedFolderContent ="$mongoDbPath\mongodb-win32-x86_64-2008plus-ssl-3.6.2"
